...
router.get('/', authMiddleware_1.protect, courseController_1.getAllCourses);
...
router.delete('/content/:id', authMiddleware_1.protect, (0, authMiddleware_1.authorize)('TEACHER', 'ADMIN'), courseController_1.deleteContent);
// Admin Enrollments
